...
iterations = 0
sleep_s = 20
health_check = "http://localhost:5555/rest/apigateway/health" # In die Dokumentation aufnehmen, wie API Gateway auf PC installiert wird
location = 'C:/Users/y508854/AppData/Roaming/npm/newman' # Muss variabel sein
